...
class Game{
    ...
    //When press on left mouse click
    mouseDown(evt){
        this.spaceKey = true;
    }

    //When release left mouse click
    mouseUp(evt){
        this.spaceKey = false;
    }
    ...
    //Add score when player hit the candy
    incScore(){
        this.score++;
    ...
    //Detuct lives when player hit penguin
    decLives(){
        this.lives--;
